...
- 2026-09-24: Urgent = 48h legal deadline, client/prospect waiting on Fahed, public mistake, money at risk. Channel: push notification only for now.
- 2026-09-24: Fahed available daily 12:00–20:00; weekly blocks approved (shoots Sun/Tue, sales Mon/Wed, setup Sat, review Thu).
...
- [ ] **Deliver on your page:** post each finished deliverable to Slack **#ll-noor-chief-of-staff** — what it is, file link, and what needs Fahed's decision. If Slack isn't available in your chat, add it to `01_Tools/Handoffs.md` for Noor to post.
