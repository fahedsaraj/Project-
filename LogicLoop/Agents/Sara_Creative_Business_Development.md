...
- [ ] **Deliver on your page:** post each finished deliverable to Slack **#ll-sara-creative-bizdev** — what it is, file link, and what needs Fahed's decision. If Slack isn't available in your chat, add it to `01_Tools/Handoffs.md` for Noor to post.
